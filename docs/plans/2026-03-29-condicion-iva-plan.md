...
**Files:**
- Modify: `SistemaDeStockV3/Models/AppModels.cs`
- Modify: `SistemaDeStockV3/Data/StockDbContext.cs`
...
**Step 5:** Build rápido: `dotnet build "SistemaDeStockV3.sln"`.

### Task 2: UI crear/editar cliente

**Files:**
- Modify: `SistemaDeStockV3/Components/Pages/Clientes.razor`
...
**Step 4:** Build: `dotnet build "SistemaDeStockV3.sln"`.
...
**Step 4:** Rebuild final si hubo cambios: `dotnet build "SistemaDeStockV3.sln"`.
