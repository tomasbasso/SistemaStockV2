...
- Create: `SistemaDeStockV3.Tests/DashboardVisualContractTests.cs`

**Step 1:** Escribir una prueba que lea `SistemaDeStockV3/wwwroot/css/app.css` y verifique la presencia de los tokens violeta, azul, naranja y superficies claras.  
**Step 2:** Escribir una prueba que lea `SistemaDeStockV3/Components/Pages/Home.razor` y verifique la nueva estructura visual del dashboard.  
**Step 3:** Ejecutar solo esas pruebas para confirmar que fallan antes de implementar.  

### Task 2: Theme global y layout

**Files:**
- Modify: `SistemaDeStockV3/wwwroot/css/app.css`
- Modify: `SistemaDeStockV3/Components/Layout/MainLayout.razor`
- Modify: `SistemaDeStockV3/Components/Layout/NavMenu.razor`
...
**Files:**
- Modify: `SistemaDeStockV3/Components/Pages/Home.razor`
...
**Step 1:** Ejecutar `dotnet test "SistemaDeStockV3.Tests/SistemaDeStockV3.Tests.csproj"` y confirmar verde.  
**Step 2:** Ejecutar `dotnet build "SistemaDeStockV3.sln"` y confirmar compilación exitosa.  
